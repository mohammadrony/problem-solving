...
def unigram(stories):
    ...
    sorted_unigram_freq = sorted(unigram_set.items(), key=lambda it:it[1], reverse=True)
...
def trigram(stories):
    ...
    sorted_trigram_freq = sorted(trigram_set.items(), key=lambda it:it[1], reverse=True)
